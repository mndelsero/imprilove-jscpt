...
function scrollToTop() {
  ...
  function extraerNumeroDeVariable(variable) {
   ...
   function crearPagina(e) {
    const mainSectionContacto= document.querySelector(".main-contacto")
