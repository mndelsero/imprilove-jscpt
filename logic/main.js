...
function productosIndex(categoria, section) {
  ...
  categoria.forEach(producto => {
    ...
    cardSeccion.innerHTML = `
        <img src="${producto.image}" class="card-img-top" id="producto${producto.productId}" alt="...">
        <div class="card-body">
      ...
      function desplegarBuscador() {
        ...
        function filtrarProductos(e) {
          ...
          if (productosFiltrados.length && search.value != "") {
            ...
            const opcionBusqueda = document.createElement("option")
            opcionBusqueda.innerText = `Ningún elemento del catalogo coincide con tu búsqueda, intenta de nuevo!`
            buscadorOpciones.appendChild(opcionBusqueda)
          }
        }
      }
...
function crearFooter() {
  ...
  <section class="menu-pie">
    ...
    <a href="./pages/agendas-papeleria.html">AGENDAS Y PAPELERÍA</a>
